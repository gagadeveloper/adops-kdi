...
const ManageClients = ({ clients: initialClients }) => {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/dashboard/manage-clients/client_hantaran/add" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center">
              ...
              {clients.map((client) => (
                <tr key={client.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap space-x-2">
                    <button
                      onClick={() => router.push(`/dashboard/manage-clients/client_hantaran/${client.id}`)}
                    ...
                    <button
                      onClick={() => router.push(`/dashboard/manage-clients/client_hantaran/edit?id=${client.id}`)}
