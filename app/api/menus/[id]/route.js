...
export async function PUT(req, { params }) {
  try {
    ...
    const updatedIcon = icon !== undefined ? icon : oldMenu.icon;
    const updatedPath = path !== undefined ? path : oldMenu.path;
    const updatedMenuOrder = menu_order !== undefined ? menu_order : oldMenu.menu_order;
