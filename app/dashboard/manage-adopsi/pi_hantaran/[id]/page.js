...
export default function PIHantaranDetail({ params }) {
  ...
  const handlePrintDocument = () => {
    window.open(`/api/pi_hantaran/print/${orderId}`, '_blank');
  };
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            className="p-2 rounded bg-purple-500 hover:bg-purple-600 text-white flex items-center"
            title="Cetak"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <p className="font-medium">{orderDetail.jumlah || '-'}</p>
                </div>
                <div className="mb-4">
