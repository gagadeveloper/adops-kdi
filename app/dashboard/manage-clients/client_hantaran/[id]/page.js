  ...
  if (error) {
    return (
      <div className="container mx-auto p-4">
        ...
        <div className="mt-4">
          <Link href="/dashboard/manage-clients" className="text-blue-600 hover:text-blue-800">
            Back to Clients
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-md shadow-md">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-2">
            <button
              onClick={() => router.push(`/dashboard/manage-clients/client_hantaran/edit?id=${clientId}`)}
